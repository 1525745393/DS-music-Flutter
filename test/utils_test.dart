...
void main() {
  group('DateTimeUtils', () {
    test('formatDuration hh:mm:ss', () {
      expect(DateTimeUtils.formatDuration(const Duration(hours: 1, minutes: 23, seconds: 45)),
          '1:23:45');
    });

    test('formatDuration mm:ss', () {
      expect(DateTimeUtils.formatDuration(const Duration(minutes: 3, seconds: 5)),
          '03:05');
    });
